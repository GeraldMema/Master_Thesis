...
class Crossover_Operator:
    def __init__(self, p1, p2, crossover_method, chromosome_length):
        self.parent_1 = p1
        self.parent_2 = p2
    ...
    def single_point_crossover(self):
        ...
        # collect genes for o1
        genes_from_p1_to_o1 = self.parent_1[0:m + 1]
        genes_from_p2_to_o1 = self.parent_2[m + 1:]
        # collect genes for o2
        genes_from_p2_to_o2 = self.parent_2[0:m + 1]
        genes_from_p1_to_o2 = self.parent_1[m + 1:]
        # produce offspring
        o1 = genes_from_p1_to_o1 + genes_from_p2_to_o1
        o2 = genes_from_p2_to_o2 + genes_from_p1_to_o2
        return o1, o2
    ...
    def two_point_crossover(self):
        ...
        m1 = cross_points[0]
        m2 = cross_points[1]
        o1 = self.parent_1[0:m1 + 1] + self.parent_2[m1 + 1:m2 + 1] + self.parent_1[m2 + 1:]
        o2 = self.parent_2[0:m1 + 1] + self.parent_1[m1 + 1:m2 + 1] + self.parent_2[m2 + 1:]
        return o1, o2
    ...
    def three_point_crossover(self):
        ...
        m2 = cross_points[1]
        m3 = cross_points[2]
        o1 = self.parent_1[0:m1 + 1] + self.parent_2[m1 + 1:m2 + 1] + self.parent_1[m2 + 1:m3 + 1] + self.parent_2[
                                                                                                     m3 + 1:]
        o2 = self.parent_2[0:m1 + 1] + self.parent_1[m1 + 1:m2 + 1] + self.parent_2[m2 + 1:m3 + 1] + self.parent_1[
                                                                                                     m3 + 1:]
        return o1, o2
    ...
    def uniform_crossover(self):
        ...
        for i in range(self.chromosome_length):
            ...
            if r >= 0.5:
                o1.append(self.parent_1[i])
                o2.append(self.parent_2[i])
            else:
                o1.append(self.parent_2[i])
                o2.append(self.parent_1[i])
        return o1, o2
